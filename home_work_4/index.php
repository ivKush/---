...
$work_experience = [
    [
        'должность' => 'кошка',
        'дата' => '2017 - ',
        'описание' => 'Обязанности: мурчать, играть, гулять, есть все что дадут',
    ],
    [
        'должность' => 'кошечка',
        'дата' => '2015 - 2017',
        'описание' => 'Обязанности: играть с хозяевами, не сильно шкодить',
    ],
    [
        'должность' => 'котенок',
        'дата' => '2014 - 2015',
        'описание' => 'Обязанности: играть, пить молоко',
    ],
]
                    ...
                    <?php for ($i = 0; $i < count($work_experience); $i++) { ?>
                        <?php if ($i == 0) { ?>
                            <div class="w3-container">
                                ...
                                <p><?= $work_experience[$i]["описание"] ?> </p>
                            <?php } ?>
                            <p>
                            <h5><b><?= $work_experience[$i]["должность"]; ?></b></h5>
                            </p>
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $work_experience[$i]["дата"]; ?></h6>
                            <p><?= $work_experience[$i]["описание"]; ?></p>
                        <?php } ?>
                        <hr>
                            </div>
